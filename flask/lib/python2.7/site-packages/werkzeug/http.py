...
def dump_cookie(
    ...
    :param path: limits the cookie to a given path, per default it will
                 span the whole data.
    :param domain: Use this if you want to set a cross-data cookie. For
                   example, ``data=".example.com"`` will set a cookie
                   that is readable by the data ``www.example.com``,
