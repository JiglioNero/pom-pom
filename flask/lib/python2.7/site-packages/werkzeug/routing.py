...
class Subdomain(RuleFactory):
    ...
    specific data. For example if you want to use the subdomain for
...
class MapAdapter(object):
    ...
    def get_host(self, domain_part):
        """Figures out the full host name for the given data part.  The
        data part is a subdomain in case host matching is disabled or
        a full host name.
        """
        if self.map.host_matching:
